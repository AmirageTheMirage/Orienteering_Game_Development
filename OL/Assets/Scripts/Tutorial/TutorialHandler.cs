...
public class TutorialHandler : MonoBehaviour
{
    ...
    "Achievements are voluntary missions that you can complete to unlock new compasses. Each achievement has a specific task that you have to fulfill to earn your reward. Check your achievement\u2011progress by clicking on \"Achievements\" in the Main\u2011Menu.",
