...
public class TutorialHandler : MonoBehaviour
{
    ...
    string[] TitleTexts = { "ThisIsElement[0]", "Thank you!", "Compass-Usage", "Map", "Find-Posts-Mode", "Orienteering-Mode", "Achievements", "Settings", "Controls" };
    string[] ActualTexts = {
    "ThisIsElement[0]",
    ...
    "There are two gamemodes implemented. In Find\u2011Posts\u2011Mode, you will start next to a post and have to find the other one. Use your map to find out at which post you are, and move to the second post. Walk into the post you targeted so you can check it off.",
